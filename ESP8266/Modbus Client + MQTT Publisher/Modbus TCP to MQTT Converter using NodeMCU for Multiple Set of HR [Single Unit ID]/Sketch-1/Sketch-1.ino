...
const int START_REGS[NUM_SETS] = {0, 2, 6};  // Starting holding register addresses for each set
const int NUM_REGS[NUM_SETS] = {2, 2, 2};    // Number of holding registers to read for each set
